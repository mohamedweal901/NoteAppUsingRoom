...
import com.example.notesroompractice.adapters.NoteAdapter
...
class HomeFragment : Fragment(R.layout.fragment_add_note), SearchView.OnQueryTextListener,MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteFab.setOnClickListener{veiw->
            veiw.findNavController().navigate(R.id.action_homeFragment_to_addNoteFragment)
        }
    ...
    private fun searchNote(query:String?){
        ...
        noteViewModel.serachNote(searchQuery).observe(this){list->
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
        ...
        val searchMenu= menu.findItem(R.id.searchMenu).actionView as SearchView
